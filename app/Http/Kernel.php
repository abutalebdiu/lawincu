...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \SalimHosen\Core\Http\Middleware\GeoLocatorMiddleware::class,
            ...
            \SalimHosen\Core\Http\Middleware\EmailVerificationMiddleware::class,
            \SalimHosen\Core\Http\Middleware\HttpsProtocol::class,
