...
<title>{{ __("Create Contact") }}</title>
    <meta name="description" content="Contact Create and Manage Contact Details">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("contacts.store") }}">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="phone" class="form-control py-3" placeholder="{{ __("Phone") }}" aria-label="phone" aria-describedby="phone">
            </div>
