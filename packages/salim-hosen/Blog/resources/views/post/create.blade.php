        ...
        <div class="card-body">
            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="tags-input form-control @error('keywords') is-invalid @enderror" type="text" name="keywords" id="keywords" value="{{ old('keywords', '') }}">
                    @error("keywords")
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('short_description') is-invalid @enderror" name="short_description" id="short_description" cols="30" rows="3">
                ...
                <div class="mb-3">
                    <label for="category">Choice Tag</label>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('meta_keywords') is-invalid @enderror" type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', '') }}">
                    @error("meta_keywords")
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('meta_description') is-invalid @enderror" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', '') }}">
