...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="slider-content">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima incidunt magni similique vero
    ...
    <section class="py-2 my-5">
        <div class="container">
            <div class="row px-5 bg-secondary py-4">
                ...
                <div class="col-12 col-sm-6 col-md-3 mb-2 mb-md-5">
                    <div class="agency">
                        <div class="card border-0">
                            <img src="{{ asset('images/Image-01.png') }}" class="card-img-top" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 py-5">
                    <h3>Corporate legal aid Services and Tax Papers Completion </h3>
                    <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsum pariatur consequuntur commodi
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title">
                        <h2>Our Services</h2>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Blanditiis nobis quos rem deserunt
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4  mb-2 mb-md-3">
                    <div class="ourserviceitem text-center p-2 p-md-3 bg-white rounded">
                        <img src="{{ asset('uploads/icons/icon-01.png') }}" alt="">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6">
                    <div class="specialist">
                        <p>Are your Tax Specialist?</p>
                        <h1>Join with us to provide your tax related services</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="page-title py-5">
                        <h3>Our Blog</h3>
                        <p>Lorem ipsum dolor sit amet consectetur. Vitae metus nulla mauris est tristique ultrices
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="blog-item">
                        <img src="{{ asset('images/Image-01.png') }}" class="w-100" alt="">
                        <p class="d-flex p-2 mt-2">
                            <span>22 July 2023</span>
                            <span>|</span>
                            <span>Admin</span>
                        </p>
                        <h4>This program helps small business incubators leverage</h4>
